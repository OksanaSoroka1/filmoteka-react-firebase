...
const homeMenu = [{ linkName: 'Trending', path: `trending` }, { linkName: 'Top-rated', path: `top-rated` },
{ linkName: 'Upcoming', path: `upcoming` }]
    ...
    return (
        <StiledSiteNav>
            <StyledNavList site>
                ...
                <SiteNavEl  path={`/LICENSE` } linkName='Home' menuList={homeMenu}></SiteNavEl>
